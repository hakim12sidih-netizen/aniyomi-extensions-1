...
data class Anime(
    ...
    @SerialName("updatedDateVF") val updateTimeVf: Long? = null,
)
...
data class EpisodeLanguages(
    @SerialName("vf") val vf: EpisodeLanguage? = null,
    @SerialName("vo") val vo: EpisodeLanguage? = null,
)

@Serializable
data class EpisodeLanguage(
    @SerialName("lecteurs") val players: List<String> = emptyList(),
)
